...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/pretty_errors-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=11210&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/pretty_errors-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `pretty_errors` can be installed with:

```
conda install pretty_errors
```

It is possible to list all of the versions of `pretty_errors` available on your platform with:
